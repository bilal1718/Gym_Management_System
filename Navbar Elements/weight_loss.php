...
<div class="flip-card-container" style="--hue: 220">
  <div class="flip-card">
    ...
    <figure>
     ...
     <li> - Deadlifts: 3 sets of 10-12 reps</li>
     <li> - Bench press: 3 sets of 12-15 reps</li>
     <li> - Rows: 3 sets of 12-15 reps</li>
     <li> - Pull-ups or lat pulldowns: 3 sets of 10-12 reps</li>
...
<div class="flip-card-container" style="--hue: 170">
  <div class="flip-card">
    ...
    <figure>
      ...
      <ul>
     <li> - Shoulder press: 3 sets of 12-15 reps</li>
     <li>- Bicep curls: 3 sets of 12-15 reps</li>
     <li>- Tricep extensions: 3 sets of 12-15 reps</li>
     <li>- Leg press: 3 sets of 12-15 reps</li>
     <li>- Leg curls: 3 sets of 12-15 reps</li>
     <li>- Crunches or sit-ups: 3 sets of 20-25 reps</li>
      </ul>
    </div>
